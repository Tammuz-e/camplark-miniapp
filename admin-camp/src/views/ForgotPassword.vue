...
import { requestPasswordReset, resetPassword } from '../api/public'
...
async function onReset() {
  ...
  if (!PASSWORD_REG.test(newPassword)) { Message.warning('密码支持字母、数字和符号'); return }
...
.forgot-card { width: 100%; max-width: 400px; padding: 48px 40px; border-radius: 4px; border: 1px solid #e5e6eb; background: #fff; box-shadow: 0 2px 8px rgba(0,0,0,.04); margin: 20px; }
